 ...
 * 
 */
class FakturaGotowka extends Gotowka
{
    ...
    protected function genVat__EwidVAT():void
    {
        ...
        $zapytanieSQL['ev_Opis']=(string) '-'; // varchar		
//zmiana wartosci maly pojazd z 4 na 0         
        $zapytanieSQL['ev_MalyPojazd']=(int) 0;// Lp. 37
		
// przypadek szczegolny piT - 0 nie dotyczy, 1 dla odliczenie 20% poj wspólnika, 2 dla odliczenia 75%
        $zapytanieSQL['ev_PrzypadekSzczegolnyPIT']=(int) 0;// Lp. 62
    ...
    protected function genDkr__Dokument():void
    {
        ...
        $zapytanieSQL['dkr_Opis']=(string) '-'; // varchar
    ...
    protected function genDkr_Pozycja():void
    {
        ...
        $this->nzd_IdDekretu=$this->dko_Id+3;
